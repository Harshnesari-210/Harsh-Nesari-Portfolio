...
const AboutSection = () => {
  const techStack = {
    frontend: [
      { name: "HTML", icon: Code, level: "Advanced", color: "text-orange-600" },
      { name: "Tailwind CSS", icon: PenTool, level: "Intermediate", color: "text-sky-500" },
      { name: "JavaScript", icon: FileCode, level: "Advanced", color: "text-yellow-500" },
      { name: "React.js", icon: Cpu, level: "Intermediate", color: "text-blue-500" },
      { name: "Framer Motion", icon: LayoutGrid, level: "Intermediate", color: "text-purple-500" },
    ],
    backend: [
      { name: "Flask", icon: ServerCog, level: "Intermediate", color: "text-gray-700" },
      { name: "Node.js", icon: Terminal, level: "Intermediate", color: "text-green-600" },
      { name: "MongoDB", icon: Database, level: "Intermediate", color: "text-green-500" },
    ],
    tools: [
      { name: "Git", icon: Code, level: "Advanced", color: "text-orange-600" },
      { name: "GitHub", icon: Github, level: "Advanced", color: "text-gray-900" },
      { name: "VS Code", icon: Code, level: "Advanced", color: "text-blue-600" },
      { name: "Postman", icon: FileCode, level: "Intermediate", color: "text-orange-500" },
    ],
  };
